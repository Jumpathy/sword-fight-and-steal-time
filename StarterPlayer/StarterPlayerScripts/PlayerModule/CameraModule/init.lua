...
function CameraModule.new()
	...
	if  UserInputService.TouchEnabled or not  UserInputService.TouchEnabled then
...
function CameraModule:Update(dt)
	self.activeCameraController:SetIsMouseLocked(script.Parent.Parent.Parent:WaitForChild("isShiftlock").Value)
	if self.activeCameraController then
		if FFlagUserCameraToggle then
...
function CameraModule:OnMouseLockToggled()
	game.Players.LocalPlayer:WaitForChild("isShiftlock").Value =  self.activeMouseLockController:GetIsMouseLocked() 
