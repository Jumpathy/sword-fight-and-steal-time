...
function MouseLockController:OnMouseLockToggled()
	print("MouseLockController:OnMouseLockToggled")
...
print(" MouseLockController:DoMouseLockSwitch")	
...
function MouseLockController:BindContextActions()
	print(" MouseLockController:BindContextActions")
	print("MouseLockController:BindContextActions")
...
function MouseLockController:UnbindContextActions()
	print("MouseLockController:UnbindContextActions")
	ContextActionService:UnbindAction(CONTEXT_ACTION_NAME)
end

function MouseLockController:IsMouseLocked()
	print("MouseLockController:IsMouseLocked")
	return self.enabled and self.isMouseLocked
end

function MouseLockController:EnableMouseLock(enable)
	print("MouseLockController:EnableMouseLock")
