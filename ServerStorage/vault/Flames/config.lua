return {
	...
	Grips = {
		Up = CFrame.new(0,0,1.65,1,0,0,0,0,1,0,-1,0),
		Out = CFrame.new(-0,-0,1.65,1,0,-0,-0,1,0,-0,0,-1)
	},
	
	KillEffect = function(character,objects)
		for _,basePart in pairs(objects) do
			basePart:Transparent();
			basePart:AddParticle(game:GetService("ServerStorage").particles.confetti);
			basePart:SetCollisions(false);
		end
	end
}