...
local eliteChat = ChatService:AddChannel("Elite Chat");
shared.add_to_elite = function(p)
	--ChatService:GetSpeaker(p.Name):JoinChannel("Elite Chat");
end
...
game:GetService("ReplicatedStorage"):WaitForChild("events"):WaitForChild("typingIndicator").OnServerEvent:Connect(function(plr,bool)
	if(type(bool) == "boolean") then
		game:GetService("ReplicatedStorage"):WaitForChild("events"):WaitForChild("typingIndicator"):FireAllClients(plr,bool);
	end
end)