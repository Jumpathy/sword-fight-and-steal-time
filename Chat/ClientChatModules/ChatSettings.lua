...
module.ChatChannelsTabTextSize = 15
module.ChatBarTextSize = 15
module.ChatWindowTextSizePhone = 13
module.ChatChannelsTabTextSizePhone = 13
module.ChatBarTextSizePhone = 13
...
---[[ Message Settings ]]
module.MaximumMessageLength = 300
